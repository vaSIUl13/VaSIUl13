  ...
  burgers: [
    {
      ...
      price: 150,
      desc: "Соковита котлета, свіжі овочі та соус на вибір.",
      img: "../lab1/img/sub_menu/burgers/classic_burger.jpg",
    },
    {
      name: "Бургер з сиром",
      price: 170,
      desc: "Сир, соковита котлета та соус на вибір.",
      img: "../lab1/img/sub_menu/burgers/cheese_burger.png",
    },
    {
      name: "Бургер з беконом",
      price: 190,
      desc: "Бекон, соковита котлета та соус на вибір.",
      img: "../lab1/img/sub_menu/burgers/becon_burger.jpeg",
    },
  ],
  pizza: [
    {
      name: "Маргарита",
      price: 200,
      desc: "Томатний соус, моцарела та базилік.",
      img: "../lab1/img/sub_menu/pizza/margaritta.webp",
    },
    {
      name: "Пепероні",
      price: 220,
      desc: "Пепероні, томатний соус та моцарела.",
      img: "../lab1/img/sub_menu/pizza/pepperoni.jpg",
    },
    {
      name: "Гавайська",
      price: 240,
      desc: "Курка, ананаси, томатний соус та моцарела.",
      img: "../lab1/img/sub_menu/pizza/hawaiian.avif",
    },
  ],
  rolls: [
    {
      ...
      price: 120,
      desc: "Класичний рол з рибою та овочами.",
      img: "../lab1/img/sub_menu/rolls/philadelphia.jpg",
    },
    {
      name: "Рол з лососем",
      price: 140,
      desc: "Рол з лососем та авокадо.",
      img: "../lab1/img/sub_menu/rolls/salmon-roll.webp",
    },
    {
      name: "Рол з тунцем",
      price: 160,
      desc: "Рол з тунцем та овочами.",
      img: "../lab1/img/sub_menu/rolls/tuna-roll.webp",
    },
  ],
  kebabs: [
    {
      name: "Кебаб з куркою",
      price: 130,
      desc: "Соковитий кебаб з куркою та спеціями.",
      img: "../lab1/img/sub_menu/kebabs/chicken-kebab.jpg",
    },
    {
      name: "Кебаб з яловичиною",
      price: 150,
      desc: "Соковитий кебаб з яловичиною та спеціями.",
      img: "../lab1/img/sub_menu/kebabs/beef-kebab.webp",
    },
    {
      name: "Кебаб з овочами",
      price: 110,
      desc: "Кебаб з овочами та спеціями.",
      img: "../lab1/img/sub_menu/kebabs/vegetarian-kebab.webp",
    },
  ],
  bowls: [
    {
      name: "Боул з кіноа",
      price: 180,
      desc: "Боул з кіноа, овочами та соусом на вибір.",
      img: "../lab1/img/sub_menu/bowls/kinoa-bowl.webp",
    },
    {
      name: "Боул з куркою",
      price: 200,
      desc: "Боул з куркою та овочами.",
      img: "../lab1/img/sub_menu/bowls/chicken-bowl.jpg",
    },
    {
      name: "Боул з лососем",
      price: 220,
      desc: "Боул з лососем та овочами.",
      img: "../lab1/img/sub_menu/bowls/salmon-bowl.jpg",
    },
  ],
  cakes: [
    {
      ...
      price: 250,
      desc: "Солодкий шоколадний торт з кремом.",
      img: "../lab1/img/sub_menu/cakes/chocolate-cake.avif",
    },
    {
      name: "Ванільний торт",
      price: 230,
      desc: "Солодкий ванільний торт з кремом.",
      img: "../lab1/img/sub_menu/cakes/vanilla-cake.jpg",
    },
    {
      name: "Фруктовий торт",
      price: 270,
      desc: "Солодкий фруктовий торт з кремом.",
      img: "../lab1/img/sub_menu/cakes/fruit-cake.jpg",
    },
  ],
};
...
document.querySelectorAll(".card__menu-btn").forEach((button) => {
  button.addEventListener("click", (e) => {
    ...
    modalTitle.innerText =
      button.parentElement.querySelector(".menu__card-title").innerText;
...
function updateCartUI() {
  ...
  if (cart.length === 0) {
    cartItemsList.innerHTML =
      '<li style="text-align:center; padding:20px;">Кошик порожній</li>';
    return;
  }
